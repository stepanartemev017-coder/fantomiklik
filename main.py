...
SEXTING_LIST = (
    ...
    "— `Ой, пересматривала галерею и нашла одно фото... я тут такая настоящая. Показать?` \n"
    "— **Тизер:** Лицо или губы. \n— **Добивка:** `Кажется, ты дар речи потерял... 😉` \n\n"
    "2. **СЦЕНАРИЙ: 'ВЫБОР ОБРАЗА'**\n"
    "— `Хочу сегодня вечером быть особенной для тебя... Поможешь выбрать белье под это платье?` \n"
    "— **Тизер:** Белье на кровати. \n— **Добивка:** `Черный — это страсть, а кружево — нежность... Что выберешь?` \n\n"
    ...
    "— **Тизер:** Плечи в полотенце. \n— **Добивка:** `Хочу почувствовать твои руки на своей коже...` \n\n"
    "5. **СЦЕНАРИЙ: 'СОН'**\n"
    "— `Мне приснился очень яркий сон... и ты там был не совсем в одежде. 😊` \n"
    "— **Тизер:** Сонные глаза под одеялом. \n— **Добивка:** `Если я расскажу детали, ты не сможешь работать...` "
)

# --- ПРОМТЫ ДЛЯ ИИ ---
PROMPTS_LIST = (
    "📝 **ПРОМТЫ ДЛЯ ИИ (Копируй и шли боту)**\n\n"
...
def handle_msg(message):
    ...
    if text == "🤖 ИИ Ассистент":
        ...
        bot.send_message(chat_id, "🦾 Режим ИИ активен. Присылай ситуацию или промт, и я помогу с текстом.")
        return
