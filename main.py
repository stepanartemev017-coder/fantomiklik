...
def cmd_start(message):
    ...
    bot.send_message(message.chat.id, "Ethera запущена. Все функции в меню клавиатуры:", reply_markup=main_keyboard())
...
def handle_msg(message):
    ...
    if res and res[1] == "ai":
        ...
        bot.send_message(chat_id, "Выбери нужный раздел в меню ниже:", reply_markup=main_keyboard())
